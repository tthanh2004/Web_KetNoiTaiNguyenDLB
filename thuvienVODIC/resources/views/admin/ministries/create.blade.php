...
@section('content')
<h1 class="text-2xl font-bold text-gray-800 mb-6">Thêm Bộ ngành mới</h1>
    ...
    <form action="{{ route('admin.ministries.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div class="col-span-1">
                ...
                <input type="text" name="code" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2 border uppercase" 
                       required placeholder="VD: BTNMT">
                @error('code')
            ...
            <div class="col-span-2">
                ...
                <input type="text" name="name" class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 p-2 border" 
                       required placeholder="VD: Bộ Tài nguyên và Môi trường">
                @error('name')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>

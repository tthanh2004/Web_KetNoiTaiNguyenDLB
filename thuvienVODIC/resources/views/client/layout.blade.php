    ...
    <header class="bg-white/95 backdrop-blur-md border-b border-blue-100 sticky top-0 z-50 shadow-sm transition-all duration-300">
        <div class="container mx-auto px-4 sm:px-6 py-3">
            <div class="flex items-center">
                ...
                <nav class="hidden lg:flex items-center space-x-6 text-sm font-bold text-blue-900 ml-auto mr-6">
                    
                    <a href="{{ route('home') }}" class="hover:text-cyan-600 transition-colors py-2 flex items-center gap-1.5 {{ request()->routeIs('home') ? 'text-cyan-700' : '' }}">
                        <i class="fa-solid fa-house-chimney"></i> Trang chủ
                    </a>

                    <div class="relative group py-2 cursor-pointer">
                        <span class="flex items-center gap-1.5 hover:text-cyan-600 transition-colors">
                            <i class="fa-solid fa-magnifying-glass"></i> Tra cứu 
                            <i class="fa-solid fa-caret-down text-[10px] opacity-60"></i>
                        </span>
                        <div class="dropdown-menu absolute left-0 top-full w-56 bg-white border border-blue-100 shadow-xl rounded-xl py-2 mt-1">
                            <a href="#" class="block px-4 py-2.5 hover:bg-blue-50 hover:text-cyan-700 transition-colors text-slate-600 font-medium">
                    ...
                    <a href="#" class="hover:text-cyan-600 transition-colors py-2 flex items-center gap-1.5">
                    ...
                    <div class="relative group py-2 cursor-pointer">
                        ...
                        <div class="dropdown-menu absolute left-0 top-full w-64 bg-white border border-blue-100 shadow-xl rounded-xl py-2 mt-1">
                            <a href="#" class="block px-4 py-2.5 hover:bg-blue-50 hover:text-cyan-700 transition-colors border-b border-blue-50 text-slate-600 font-medium">
                    ...
                    <div class="relative group py-2 cursor-pointer">
                        ...
                        <div class="dropdown-menu absolute right-0 top-full w-64 bg-white border border-blue-100 shadow-xl rounded-xl py-2 mt-1">
                            <a href="#" class="block px-4 py-2.5 hover:bg-blue-50 hover:text-cyan-700 transition-colors text-slate-600 font-medium">
                            ...
                            <a href="#" class="block px-4 py-2.5 hover:bg-blue-50 hover:text-cyan-700 transition-colors border-t border-blue-50 mt-1 pt-2 text-slate-600 font-medium">
                    ...
                    <div class="relative group py-2 cursor-pointer">
                        <span class="flex items-center gap-1.5 hover:text-cyan-600 transition-colors {{ request()->routeIs('client.request.*') ? 'text-cyan-700' : '' }}">
                            <i class="fa-solid fa-life-ring"></i> Trợ giúp 
                            <i class="fa-solid fa-caret-down text-[10px] opacity-60"></i>
                        </span>
                        <div class="dropdown-menu absolute right-0 top-full w-64 bg-white border border-blue-100 shadow-xl rounded-xl py-2 mt-1">
                            <a href="{{ route('client.request.create') }}" class="block px-4 py-2.5 hover:bg-blue-50 hover:text-cyan-700 transition-colors border-b border-blue-50 text-slate-600 font-medium">
                    ...
                    @if (Route::has('login'))
                        @auth
                            <div class="relative group hidden lg:block">
                                ...
                                <div class="dropdown-menu absolute right-0 top-full w-56 bg-white border border-blue-100 shadow-lg rounded-xl py-2 mt-2">
                                    <a href="{{ route('admin.dashboard') }}" class="block px-4 py-2 text-sm text-slate-700 hover:bg-blue-50 hover:text-blue-700 font-medium">
                        ...
                        @else
                            <a href="{{ route('login') }}" class="hidden lg:flex items-center gap-2 bg-blue-900 text-white px-5 py-2.5 rounded-full font-bold text-xs shadow-md hover:bg-cyan-700 hover:shadow-lg transition-all transform hover:-translate-y-0.5">
            ...
            <nav class="flex flex-col p-4 space-y-2 text-sm font-medium text-slate-700 max-h-[80vh] overflow-y-auto">
                ...
                <div class="block p-3 hover:bg-blue-50 rounded-lg">
                    ...
                    <div class="pl-8 space-y-2 text-slate-500 text-xs">
                        <a href="#" class="block">• Theo Dự án</a>
                        <a href="#" class="block">• Theo Sản phẩm</a>
                    </div>
                </div>

                <a href="#" class="block p-3 hover:bg-blue-50 rounded-lg">
                ...
                <div class="block p-3 hover:bg-blue-50 rounded-lg">
                    ...
                    <div class="pl-8 space-y-2 text-slate-500 text-xs">
                        <a href="#" class="block">• Biểu mức thu phí</a>
                        <a href="#" class="block">• Đề nghị cung cấp dữ liệu</a>
                    </div>
                </div>
                ...
                <div class="block p-3 hover:bg-blue-50 rounded-lg">
                    ...
                    <div class="pl-8 space-y-2 text-slate-500 text-xs">
                        <a href="#" class="block">• Theo Dự án / Đề án</a>
                        <a href="#" class="block">• Theo đơn vị thực hiện</a>
                    </div>
                </div>
                ...
                <div class="border-t border-blue-100 my-2 pt-2">
                    @auth
                        <a href="{{ route('admin.dashboard') }}" class="block p-3 text-slate-600 hover:text-blue-700">
                            <i class="fa-solid fa-gauge w-6 text-center"></i> Vào trang quản trị
                        </a>
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class="w-full text-left p-3 text-red-600 hover:bg-red-50 rounded-lg">
                                <i class="fa-solid fa-right-from-bracket w-6 text-center"></i> Đăng xuất
                            </button>
                        </form>
                    @else
                        <a href="{{ route('login') }}" class="block p-3 text-center bg-blue-900 text-white rounded-lg mt-2 font-bold shadow">
                            Đăng nhập
                        </a>
                    @endauth
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-slate-500">
                        <li><a href="#" class="hover:text-cyan-600 transition-colors">Giới thiệu chung</a></li>
                        <li><a href="#" class="hover:text-cyan-600 transition-colors">Cơ cấu tổ chức</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-slate-500">
                        <li><a href="#" class="hover:text-cyan-600 transition-colors">Hướng dẫn tra cứu</a></li>

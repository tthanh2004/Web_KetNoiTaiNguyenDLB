...
<div class="bg-slate-50 min-h-screen py-10">
    <div class="container mx-auto px-4 md:px-6 max-w-5xl">
        ...
        <div class="text-center mb-12">
            ...
            <p class="text-slate-500">Top các đơn vị có đóng góp nhiều nhất trong công tác điều tra cơ bản tài nguyên môi trường biển.</p>
        </div>

        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            <div class="p-6 border-b border-slate-100 bg-slate-50 flex justify-between items-center">
                <h3 class="font-bold text-slate-700 uppercase tracking-wide text-sm">Bảng xếp hạng đơn vị</h3>
            ...
            <div class="p-6 md:p-8">
                @if($units->count() > 0)
                    @php 
                        $maxProjects = $units->first()->projects_count; // Lấy số lớn nhất để tính % width
                    @endphp
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="relative group">
                            ...
                            <div class="w-full bg-slate-100 rounded-full h-3 overflow-hidden">
                                <div class="h-full rounded-full transition-all duration-1000 ease-out relative group-hover:shadow-[0_0_10px_rgba(59,130,246,0.5)]
                ...
                @else
                    <div class="text-center py-10">
                        ...
                        <p class="text-slate-500">Chưa có dữ liệu thống kê.</p>
                    </div>
                @endif
            </div>
        </div>
